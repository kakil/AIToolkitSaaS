...
const JavascriptScreen = () => { 
    ...
    const javascriptHandler = async (e) => { 
        e.preventDefault();
    ...
    return (
        ...
        >
            ...
            <form onSubmit={javascriptHandler}>
                <Typography variant="h3" mb={2}>Javascript Generator</Typography>
                <Stack direction="row" spacing={1}>
                    <Box width="87%">
                        <TextField multiline={Boolean(true)} placeholder="Enter instructions here" fullWidth value={text} onChange={(e) => setText(e.target.value)}/>
                    </Box>
